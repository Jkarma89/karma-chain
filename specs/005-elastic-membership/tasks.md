...
- [~] T043 [US4] **先拿四个数**（research R-07 / V-13…V-15）：
      ...
      **③ 是单向门，不再往下做**：`minStakeDuration` = 24 小时，加进 P 链验证者集合后
      24 小时内无法撤回，且那个节点从此不能再带 `partial-sync` 启动
      （见 R-07a③ 的错误常量）—— 所以它实际上就是 T045 的第一步，
      应当**在 T044 做出决定之后**再做，并事先接受 24 小时不可逆。
